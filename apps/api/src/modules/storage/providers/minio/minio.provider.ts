...
import IMinioProvider from './minio.interface';

export default class MinioProvider implements IMinioProvider {
   ...
   public async saveFileFromBuffer(buffer: Buffer): Promise<string> {
      ...
      if (!fileTypeResult) {
         throw new BadRequestException(
            'Não foi possível determinar o tipo de arquivo do buffer.',
         );
      }
